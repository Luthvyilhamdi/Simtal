        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <div class="foto-upload-wrap">
                    ...
                    <button type="button" id="btnHapusFoto" class="btn-hapus-foto" onclick="hapusFotoAction()" style="display:none;">
...
<script>
    ...
    function hapusFotoAction() {
        // Batalkan pilihan foto (belum tersimpan) → kembali ke placeholder.
        fFile.value = '';
    ...
    function cropCancel() { closeCrop(); fFile.value = ''; }
