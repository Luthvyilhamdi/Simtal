...
<style>
    ...
    .section-label { font-size: 13px; font-weight: 700; color: #374151; margin: 24px 0 16px; padding-bottom: 8px; border-bottom: 1px solid #f3f4f6; }
</style>
@endpush
