...
<style>
    ...
    .final-qualified { background:#dcfce7;color:#15803d; }
    ...
    <div style="display:flex;gap:10px;flex-wrap:wrap;">
        ...
        <a href="{{ route('history_assessment_all.export', request()->query()) }}"
           style="display:inline-flex;align-items:center;gap:8px;background:#7c3aed;color:white;padding:10px 18px;border-radius:10px;font-size:13px;font-weight:600;text-decoration:none;white-space:nowrap;">
            <svg viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2" style="width:14px;height:14px;"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
            Export Excel
        </a>
    </div>
</div>
...
<div class="tab-wrap">
    <button class="tab-btn active" id="tab-rekom" onclick="switchTab('rekom')">
        📋 Assessment Rekomendasi ({{ $stats['total'] }})
    </button>
    <button class="tab-btn" id="tab-komp" onclick="switchTab('komp')">
        ⭐ Assessment Kompetensi ({{ $stats['total_kompetensi'] }})
    </button>
</div>
                    ...
                    <tr>
                        <td colspan="12">
                            <div class="empty-state">
                                ...
                                <p style="font-size:14px;font-weight:600;color:#6b7280;margin-bottom:4px;">Belum ada data assessment rekomendasi</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $ak->periode ?? '-' }}</td>
                        <td>
                            <span style="font-size:16px;font-weight:800;color:{{ $ak->total_competency_under > 0 ? '#dc2626' : '#15803d' }};">
                                {{ $ak->total_competency_under }}
                            </span>
                        </td>
                        <td>
                            <span style="font-size:16px;font-weight:800;color:{{ $ak->total_qualification_under > 0 ? '#dc2626' : '#15803d' }};">
                        ...
                        <td style="max-width:160px;overflow:hidden;text-overflow:ellipsis;color:#6b7280;font-style:italic;">
                            {{ $ak->keterangan ?? '-' }}
                        </td>
                        <td>
                            <button type="button" class="btn-del"
                    ...
                    <tr>
                        <td colspan="8">
                            <div class="empty-state">
                                <svg viewBox="0 0 24 24"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg>
                                <p style="font-size:14px;font-weight:600;color:#6b7280;margin-bottom:4px;">Belum ada data assessment kompetensi</p>
                            </div>
                        </td>
                    </tr>
                    @endforelse
