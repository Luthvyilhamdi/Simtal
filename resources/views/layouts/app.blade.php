...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <a href="{{ route('surat_penting.index') }}" data-tooltip="Surat Penting"
            class="nav-link {{ request()->routeIs('surat_penting.*') ? 'active' : '' }}">
        ...
        <div class="nav-section">
            ...
            <a href="#" data-tooltip="FAQ" class="nav-link">
        ...
        <div class="nav-section">
            ...
            <a href="{{ route('activity_log.index') }}" data-tooltip="Log Aktivitas"
                class="nav-link {{ request()->routeIs('activity_log.*') ? 'active' : '' }}">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/>
                    <polyline points="14 2 14 8 20 8"/>
                    <line x1="16" y1="13" x2="8" y2="13"/>
    ...
    <!-- <div class="sidebar-bottom">
        <div class="user-row">
            ...
            <div class="user-info">
                ...
                <div class="user-role">{{ auth()->user()->isSuperAdmin() ? 'Super Admin' : 'Administrator' }}</div>
            </div>
        </div>
        <form method="POST" action="{{ route('logout') }}" class="logout-form">
            ...
            <button type="submit" class="logout-btn">
                ...
                <span class="logout-text">Keluar dari SIMTAL</span>
            </button>
        </form>
    </div> -->
</div>
    ...
    async function fetchNotif() {
        try {
            ...
            if (data.notifikasis.length === 0) {
                list.innerHTML = `<div style="text-align:center;padding:40px 20px;color:#9ca3af;font-size:13px;">🔔 Tidak ada notifikasi</div>`;
                return;
            }
