...
<div class="page-header">
    <div>
        ...
        <div class="page-sub">Panduan & pertanyaan yang sering ditanyakan seputar SiMental</div>
    </div>
</div>
...
<div class="contact-card">
    ...
    <p>Hubungi Admin SiMental via WhatsApp — klik tombol atau scan QR code pakai kamera HP.</p>
    <div style="display:flex;align-items:center;justify-content:center;gap:40px;flex-wrap:wrap">

        {{-- Tombol WA --}}
        <a href="https://wa.me/6285360495729?text=Halo%20Admin%20SiMental%2C%20saya%20ingin%20bertanya%20mengenai%20..."
...
document.addEventListener('DOMContentLoaded', function() {
    new QRCode(document.getElementById('qrWa'), {
        text: 'https://wa.me/6285360495729?text=Halo%20Admin%20SiMental%2C%20saya%20ingin%20bertanya%20mengenai%20...',
        width: 150,
        height: 150,
        colorDark: '#111827',
        colorLight: '#ffffff',
