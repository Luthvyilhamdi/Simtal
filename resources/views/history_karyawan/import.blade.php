        ...
        <form method="POST" action="{{ route('history_karyawan.import.store') }}" enctype="multipart/form-data" id="importForm">
            ...
            <div class="warning-box">
                ...
                <div class="warning-text">
                    <strong>Perhatian:</strong> NIK yang tidak ditemukan akan dilewati otomatis. Baris dengan <strong>tanggal_selesai kosong</strong> akan jadi jabatan aktif dan memperbarui profil karyawan. Urutkan data dari jabatan terlama ke terbaru agar history terurut dengan benar.
                </div>
            </div>
