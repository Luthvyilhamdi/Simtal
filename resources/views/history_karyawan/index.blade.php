...
<div class="page-header">
    ...
    <div style="display:flex;gap:10px;flex-wrap:wrap;">
        ...
        <a href="{{ route('history_karyawan.export') }}"
           style="display:inline-flex;align-items:center;gap:8px;background:#15803d;color:white;padding:10px 18px;border-radius:10px;font-size:13px;font-weight:600;text-decoration:none;white-space:nowrap;transition:background 0.15s;"
