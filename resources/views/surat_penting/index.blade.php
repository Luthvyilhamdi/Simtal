...
<div class="stats-grid">
    ...
    <div class="stat-card">
        <div class="stat-num" style="color:#185fa5">{{ $stats['personal'] }}</div>
    ...
    <form method="GET" id="filterForm" style="display:contents">
        ...
        <select name="kategori" class="filter-select" onchange="this.form.submit()">
            ...
            <optgroup label="Dokumen Umum">
                ...
                <option value="prosedur"  {{ request('kategori')=='prosedur'  ? 'selected' : '' }}>Prosedur / SOP</option>
...
<div id="suratGridWrap">
    ...
    <div class="surat-grid" id="suratGrid">
        ...
        <div class="surat-card {{ $isExpired ? 'expired' : ($isSoon ? 'soon-expire' : '') }}">
            @if($isExpired)<div class="expire-ribbon">EXPIRED</div>
            @elseif($isSoon)<div class="soon-ribbon">SOON</div>
            @endif
            <div class="scard-top">
                <div>
                ...
                <div class="scard-icon" @style(['background:' . $w['bg'] => !empty($w['bg'])])>
            ...
            @else
            <div class="scard-karyawan" style="background:#fff7ed;border:1px solid #fed7aa">
                <div class="scard-avatar" style="background:#fff7ed;color:#c2410c;font-size:16px">📋</div>
                <div>
                    <div class="scard-kname" style="color:#c2410c">Dokumen Umum</div>
                    <div class="scard-knik">Pedoman / Kebijakan Perusahaan</div>
                </div>
            </div>
            @endif
