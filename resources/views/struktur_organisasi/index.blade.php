...
function openPanel(karyawanId){
  ...
  fetch('/api/karyawan/'+karyawanId+'/profile').then(r=>r.json()).then(d=>{
    ...
    const rows=[['Direktorat',d.direktorat],['Kompartemen',d.kompartemen],['Departemen',d.departemen],['Tgl Masuk',d.tanggal_masuk],['Tgl Lahir',d.tanggal_lahir],['Pensiun',d.pensiun],['Lama Bekerja',d.lama_bekerja]];
